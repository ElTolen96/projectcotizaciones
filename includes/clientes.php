            ...
            <table class="table table-striped">
                ...
                <?php foreach ($clientes as $cliente) { ?>
                    <tr>
                        ...
                        <td><?php echo htmlentities($cliente->Nombre) ?> <?php echo htmlentities($cliente->Apellidos) ?></td>
                        <td><?php echo htmlentities($cliente->razonSocial) ?></td>
                        <td><?php echo htmlentities($cliente->DNI) ?></td>
                        <td><?php echo htmlentities($cliente->Fecha) ?></td>
                        <td>
